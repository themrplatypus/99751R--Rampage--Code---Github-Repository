...
ez::tracking_wheel vert_tracker(14, 2.75, 4.0);   // This tracking wheel is parallel to the drive wheels
...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      ...
      //CUSTOM AUTONS HERE!!!!!!!!!!
      {"Right Side Auton!!!", RightSideAuton},
      {"Left Side Auton!!!", LeftSideAuton},
      {"Solo Auto Win Point", SoloAWP},
